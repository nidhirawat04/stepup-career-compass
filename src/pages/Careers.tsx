        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Explore <span className="gradient-primary bg-clip-text text-transparent">Careers</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {careers.map((career) => (
              <Card key={career.id} className="p-6 hover:shadow-medium transition-smooth gradient-card">
