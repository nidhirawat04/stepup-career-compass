...
const questions = [{
  ...
  options: [{
    value: "creative",
    label: "Creating art, design, or content"
  }, {
    value: "analytical",
    label: "Solving problems and analyzing data"
  }, {
    value: "people",
    label: "Working with and helping others"
  }, {
    value: "technical",
    label: "Building or fixing technical systems"
  }]
}, {
  id: 2,
  ...
  options: [{
    value: "office",
    label: "Traditional office setting"
  }, {
    value: "remote",
    label: "Remote or flexible workspace"
  }, {
    value: "outdoor",
    label: "Outdoor or field work"
  }, {
    value: "lab",
    label: "Laboratory or research facility"
  }]
}, {
  id: 3,
  ...
  options: [{
    ...
    value: "technical",
    label: "Technical and programming skills"
  }, {
    value: "communication",
  ...
  options: [{
    ...
    value: "innovation",
    label: "Creating innovative solutions"
  }, {
    value: "stability",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="p-8 shadow-medium gradient-card">
            ...
            <div className="mb-8">
              ...
              <RadioGroup value={selectedAnswer} onValueChange={setSelectedAnswer}>
                <div className="space-y-4">
                  {questions[currentQuestion].options.map(option => <div key={option.value} className="flex items-center space-x-3 p-4 rounded-lg border-2 border-border hover:border-primary/50 transition-base cursor-pointer" onClick={() => setSelectedAnswer(option.value)}>
            ...
            <div className="flex justify-between">
              ...
              <Button onClick={handleNext} disabled={!selectedAnswer} className="gradient-primary">
