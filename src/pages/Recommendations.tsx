        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Your Career <span className="gradient-primary bg-clip-text text-transparent">Matches</span>
            </h1>
          ...
          <div className="grid gap-6">
            {careerSuggestions.map((career) => (
              <Card
                key={career.id}
                className="p-6 hover:shadow-medium transition-smooth border-2 hover:border-primary/20 gradient-card"
              >
